<template>
  <div>
    <div
      class="mt-[30px] font-bold text-lg w-full h-screen flex flex-col justify-center items-center"
    ...
    <div v-else>
      ...
      <div
        class="flex flex-col justify-end items-end bg-white rounded-b-xl shadow-xl px-6 py-4"
      >
        <div class="my-4 font-bold text-lg">
          Total: Rp {{ cartStore.totalPrice }}
        </div>
        <div class="flex flex-row gap-6">
          <ButtonPrimaryOutline @click="$router.push('/')"
            >Kembali</ButtonPrimaryOutline
          >
          <button
